<x-layouts.app title="Detail Riwayat Pasien">
    ...
    <div class="flex items-center gap-3 mb-6">
        <a href="{{ route('dokter.riwayat-pasien.index') }}" class="inline-flex items-center justify-center w-9 h-9 
                    ...
                    <table class="table table-zebra w-full">
                        ...
                        <tbody>
                            ...
                            <tr class="hover:bg-slate-50 transition">
                                ...
                                <td class="px-6 py-4 text-slate-500">Rp {{ number_format($detail->obat->harga, 0, ',', '.') }}</td>
                            </tr>
                            @endforeach
                        </tbody>
                    </table>
